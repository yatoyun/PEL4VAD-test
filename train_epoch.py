...
# def train_func(dataloader, model, optimizer, criterion, criterion2, lamda=0):
    ...
    v_ninput, clip_ninput, t_ninput, nlabel, multi_nlabel = next(normal_iter) #normal_iter
    v_ainput, clip_ainput, t_ainput, alabel, multi_alabel = next(anomaly_iter) #anomaly_iter
